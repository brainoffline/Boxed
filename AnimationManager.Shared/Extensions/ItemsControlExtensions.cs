...
namespace Brain.Animate.Extensions
{
    public static class ItemsControlExtensions
    {
        ...
        public static async Task<int> AnimateItems(
            ...
            AnimationDefinition selectedItemAnimationDefinition = null)
        {
            ...
            double baseDelay = animationDefinition.Delay;
            var visibleItems = itemsControl.VisibleItems();
            ...
            for (int index = 0; index < visibleItems.Count; index++)
            {
                ...
                var container = visibleItems[index].Target as FrameworkElement;
                if (container == null) continue;
                ...
                if (selectedItemAnimationDefinition != null)
                {
                    ...
                    var content = (contentControl != null) ? contentControl.Content : null;

                    if ((index == itemsControl.SelectedIndex) ||
                        ((selectedObject != null) && (itemsControl.Items != null) && (selectedObject == content))
                        )
                    {
                        found = true;
        ...
        public static void ClearItemAnimations(this ItemsControl itemsControl, Action<FrameworkElement> itemAction = null)
        {
            itemsControl.UpdateLayout();
        ...
        public static IList<WeakReference> VisibleItems(this ItemsControl itemsControl)
        {
            ...
            var scrollHost = VisualTreeHelper.GetChild(itemsControl, 0) as FrameworkElement;   // as ScrollViewer;
            if (scrollHost == null)
                scrollHost = itemsControl;
